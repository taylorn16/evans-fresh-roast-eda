...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> EvansFreshRoast.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> EvansFreshRoast.App.configureServices)
